...
exports.sendEmailsToSubscribers = async (db, jobData) => {
            ...
            <mj-body background-color="#f4f4f4">
                <mj-section>
                    <mj-column>
                        ...
                        <mj-text font-size="18px" color="#333333"><strong>Make:</strong> ${jobData.jobTitle}</mj-text>
                        <mj-text font-size="18px" color="#333333"><strong>Model:</strong> ${jobData.jobType}</mj-text>
                        <mj-text font-size="16px" color="#555555"><strong>Description:</strong> ${jobData.Location}</mj-text>
                        <mj-text font-size="16px" color="#555555">Tip: Hurry up! Check out this car on our website for more details.</mj-text>
                        <mj-button href="https://yourwebsite.com/cars/${jobData.id}" background-color="#346DB7" color="#ffffff">View Car Details</mj-button>
                    </mj-column>
                </mj-section>
            </mj-body>
        </mjml>
